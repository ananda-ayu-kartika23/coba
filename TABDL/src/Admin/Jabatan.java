...
private String safeGetValue(int row, int col) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        TambahJabatan fk = new TambahJabatan(new javax.swing.JFrame(), true);
    ...
    int idJabatan = safeGetValueInt(row, 0);  // ID Divisi (int)
    String namaJabatan = safeGetValue(row, 1); // Nama Divisi
    String levelJabatan = safeGetValue(row, 2); // Lokasi Divisi

    // Panggil form EditDivisi
    EditJabatan edit = new EditJabatan(
    ...
    int idJabatan = safeGetValueInt(row, 0);

    int confirm = JOptionPane.showConfirmDialog(
            this,
            "Apakah Anda yakin ingin menghapus data Jabatan dengan ID: " + idJabatan + "?",
            "Konfirmasi Hapus",
    ...
    try {
        ...
        Jabatan_1 d = em.find(Jabatan_1.class, idJabatan);
